        ...
        <div class="wrap">
            <div class="modelsContainer">
                <div class="Models">
                    ...
                    <a href="carView.php?id=4"><img src="../Public/img/car1.png"></a>
                        <p>Rolls-Royce Wraith</p>
                    </div>
                    <div class="imgAndCarName">
                    <a href="carView.php?id=5"><img src="../Public/img/car2.png"style="height: 95px"></a>
                        <p>Rolls-Royce Ghost Black</p>
                    </div>
                </div>
            </div>
        </div>
